...
fft_blackman = fft(sin_blackman)
fft_flattop = fft(sin_flattop)
fft_hamming = fft(sin_hamming)
fft_rectangle = fft(sin_rectangle)
fft_hanning = fft(sin_hanning)
...
#plot delle FFT
p1 = plot(freq, abs.(fft_blackman), xlim = lim, title = "Blackman", xlabel = "Frequence[Hz]", ylabel = "Amplitude [dBV]")
p2 = plot(freq, abs.(fft_flattop), xlim = lim, title = "Flattop", xlabel = "Frequence[Hz]", ylabel = "Amplitude [dBV]")
p3 = plot(freq, abs.(fft_hamming), xlim = lim, title = "Hamming", xlabel = "Frequence[Hz]", ylabel = "Amplitude [dBV]")
p4 = plot(freq, abs.(fft_rectangle), xlim = lim, title = "Rectangle", xlabel = "Frequence[Hz]", ylabel = "Amplitude [dBV]")
p5 = plot(freq, abs.(fft_hanning), xlim = lim, title = "Hanning", xlabel = "Frequence [Hz]", ylabel = "Amplitude [dBV]")
